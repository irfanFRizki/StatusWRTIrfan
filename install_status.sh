...
# ========================
# Fungsi 1: Update paket, Instal dependensi, paket tambahan, dan deploy semua komponen
# ========================
install_update_and_deploy() {
...
EOF
  ...
  # Pindahkan file Status Monitor jika repository sudah di-clone
...
# ========================
# Fungsi 3: Update vnstat.db dan nlbwmon (Gabungan)
# ========================
...
main_menu() {
  ...
  while true; do
    ...
    echo -e "${YELLOW}2) Update vnstat.db dan nlbwmon${NC}"
